<template>
    <section>
      ...
      <button class="big-filter-btn grid column" @click.prevent="choseSearch('when-start')" v-bind:class="{isActive: isWhenStart}"><div>Check in</div><div>Add dates</div></button>|
      <button class="big-filter-btn grid column" @click.prevent="choseSearch('when-end')" v-bind:class="{isActive: isWhenEnd}"><div>Check out</div><div>Add dates</div></button>|
